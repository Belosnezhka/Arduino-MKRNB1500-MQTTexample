...
#define TOKEN ""
#define MQTT_CLIENT_NAME "MKRNB1500" 

//broker url in here, demo is using eclipse test server
//char mqttBroker[]  = "farmer.cloudmqtt.com";
char mqttBroker[]  = "mqtt.eclipse.org";
...
char subtopic[50] = "IOT/cat";
//char pubtopic[50] = "IOT/cat";
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  //the messages can be handled using e.g JSON-libraries for arduino
  if(message.equals("hej")){
    Serial.println("hej received");
  }
}
...
void reconnect() {
    ...
    // Attemp to connect
    //example protected broker:
    //conn.connect(MQTT_CLIENT_NAME, "xhpdkszi", "tNsNHcF0kaxt")
...
void loop() {
  ...
  conn.publish(subtopic, "{\"message\":\"Hello MQTT world\"}");
